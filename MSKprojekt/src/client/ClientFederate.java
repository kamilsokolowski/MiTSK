...
public class ClientFederate
{
	...
	private void callServiceMan(Client clnt) throws Exception{
		ParameterHandleValueMap parameterHandleValueMap = rtiamb.getParameterHandleValueMapFactory().create(2);

		ParameterHandle callServiceManDistanceHandle = rtiamb.getParameterHandle(callServiceManHandle, "Distance");
		ParameterHandle callServiceManClientIdHandle = rtiamb.getParameterHandle(callServiceManHandle, "ClientID");

		HLAinteger32BE dist = encoderFactory.createHLAinteger32BE(clnt.getDistanceToFirm());
		HLAinteger32BE clntId = encoderFactory.createHLAinteger32BE(clnt.getIdClient());

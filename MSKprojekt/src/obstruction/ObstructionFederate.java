...
public class ObstructionFederate
{
    //----------------------------------------------------------
    //                    STATIC VARIABLES
    //----------------------------------------------------------
    ...
    private ObstructionFederateAmbassador fedamb;  // created when we connect
    ...
    {
        System.out.println( "ObstructionFederate   : " + message );
    }
    ...
    public void runFederate( String federateName ) throws Exception
    {
        ...
        // connect
        log( "Connecting..." );
        fedamb = new ObstructionFederateAmbassador( this );
...
//		// 10. do the main simulation loop //
        ...
        {
            if(this.fedamb.federateTime == this.timeToNextObstruction) {
                makeObstruction();
            }
            advanceTime(1);
...
//		log( "Deleted Object, handle=" + objectHandle );
    ...
    private void publish() throws RTIexception {
        String iname = "HLAinteractionRoot.Obstruction";
        obstructionHandle = rtiamb.getInteractionClassHandle(iname);
        // Publish
        rtiamb.publishInteractionClass(obstructionHandle);
    }
    ...
    private void makeObstruction() throws Exception{
    ...
    public static void main( String[] args )
    {
        ...
        String federateName = "Obstruction";
        if( args.length != 0 )
        {
            federateName = args[0];
        }
        ...
        try
        {
            ...
            new ObstructionFederate().runFederate( federateName );
        }

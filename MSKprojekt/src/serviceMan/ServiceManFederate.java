...
public class ServiceManFederate
{
	//----------------------------------------------------------
	//                    STATIC VARIABLES
	//----------------------------------------------------------
	...
	private ServiceManFederateAmbassador fedamb;  // created when we connect
	...
	protected InteractionClassHandle repairHandle;
	...
	protected ParameterHandle serviceManIdHandle;
	...
	{
		System.out.println( "ServiceManFederate   : " + message );
	}
	...
	public void runFederate( String federateName ) throws Exception
	{
		...
		// connect
		log( "Connecting..." );
		fedamb = new ServiceManFederateAmbassador( this );
...
//		log( "Deleted Object, handle=" + objectHandle );
	...
	private void publish() throws RTIexception {
		...
		// Publish
		rtiamb.publishInteractionClass(repairHandle);
	}
	...
	private void subscribe() throws RTIexception {
		...
		serviceManIdHandle = rtiamb.getParameterHandle(rtiamb.getInteractionClassHandle("HLAinteractionRoot.Obstruction"), "ServiceManId");
		delayHandle = rtiamb.getParameterHandle(rtiamb.getInteractionClassHandle("HLAinteractionRoot.Obstruction"), "Delay");

		String iname2 = "HLAinteractionRoot.Obstruction";
		obstructionHandle = rtiamb.getInteractionClassHandle(iname2);
		// Subscribe
		rtiamb.subscribeInteractionClass(obstructionHandle);
	}
	...
	public static void main( String[] args )
	{
		...
		String federateName = "ServiceMan";
		if( args.length != 0 )
		{
			federateName = args[0];
		}
		...
		try
		{
			...
			new ServiceManFederate().runFederate( federateName );
		}

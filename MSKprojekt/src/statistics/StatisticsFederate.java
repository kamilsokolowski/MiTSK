...
//		// 10. do the main simulation loop //
        ...
        {
            /*
            Iterator hmIterator = this.serviceHistory.entrySet().iterator();
            while (hmIterator.hasNext()) {
                Map.Entry mapElement = (Map.Entry) hmIterator.next();
                Integer key = (Integer) mapElement.getKey();
                StatisticsEntry stat = (StatisticsEntry) mapElement.getValue();
                System.out.println(
                        key + " Client ID: " + stat.clientId
                                + " Call Time: " + stat.callTime
                                + " Repair Time: " + stat.repairTime
                );
            }*/
            System.out.println("Average time of service: " + Statistics.average(serviceHistory) + " +/- " + Statistics.standardDeviation(serviceHistory));
            advanceTime(1);
